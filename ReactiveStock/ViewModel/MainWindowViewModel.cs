...
namespace ReactiveStock.ViewModel
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public Dictionary<string, StockToggleButtonViewModel> StockButtonsViewModels { get; set; }
        ...
        {
            _chartingActorRef = ActorSystemReference.ActorSystem.ActorOf(
                Props.Create(() => new LineChartingActor(PlotModel)));
        ...
        {
            StockButtonsViewModels = new Dictionary<string, StockToggleButtonViewModel>();
        ...
        private void CreateStockButtonViewModel(string stockSymbol)
        {
            ...
            StockButtonsViewModels.Add(stockSymbol, newViewModel);
        }
    }
}